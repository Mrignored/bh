...
download_and_extract_backhaul() {
    ...
    case "$ARCH" in
        x86_64)
            DOWNLOAD_URL="https://raw.githubusercontent.com/Mrignored/bh/refs/heads/main/backhaul-patch"
            ;;
        *)
...
SCRIPT_URL="https://raw.githubusercontent.com/Mrignored/bh/refs/heads/main/backhaul2.sh"
